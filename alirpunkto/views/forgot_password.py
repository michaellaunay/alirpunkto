...
from alirpunkto.utils import (
    ...
    get_member_by_mail,
    update_persistent_users_from_ldap,
...
def forgot_password(request):
    ...
    if 'submit' in request.POST:
        ...
        # 5) If an instance of PersistentUser (an application, or any other
        # derived object) exists for this OID it's updated from LDAP, if not, a PersistentUserDatas
        # instance is created with LDAP informations, and stored in the PersistentUserDatas list.
        # The details of the email sent to the member, such as the link, will
        # be generated by the instance's methods.
        persitent_user_datas = update_persistent_users_from_ldap(uid, request)
        ...
        reset_users[uid] = persitent_user_datas
        transaction.commit()
        ...
        email_template = "send_reset_password_email"
        send_email_to_member(
            request,
